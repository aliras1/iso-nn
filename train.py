...
# Create model
model = IsoNet(input_dim=5, hidden_dim=100, output_dim=50, L=8)
# model = torch.load("./models/iso_net7.pth")
loss = nn.BCELoss()
...
for epoch in range(num_epochs):
    ...
    if test_acc > best_test_acc:
        torch.save(model, "./models/iso_net.pth")
