...
from data import classification_label_gen
...
dataset, q = classification_label_gen.gen_dataset(num_g, min_num_nodes, max_num_nodes, edge_probability)
classification_label_gen.save_dataset(dataset, q, "tri_match_10000")
dataset, q = classification_label_gen.load_dataset("tri_match_10000")
...
# Create model
model = TriCount(input_dim=5, hidden_dim=100, output_dim=1, L=6)
loss = nn.BCELoss()
